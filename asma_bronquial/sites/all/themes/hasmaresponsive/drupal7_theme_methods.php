...
$art_style = '';
$art_head = '';
function hasmaresponsive_process_html(&$variables) {
...
function hasmaresponsive_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function hasmaresponsive_button($variables) {
 ...
 */
function hasmaresponsive_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function hasmaresponsive_menu_local_task($variables) {
 ...
 */
function hasmaresponsive_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function hasmaresponsive_node_preview($variables) {
  $node = $variables['node'];
...
*/
function hasmaresponsive_form_alter(&$form, &$form_state, $form_id) {
...
function hasmaresponsive_form_element_label($variables) {
...
function hasmaresponsive_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function hasmaresponsive_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
